...
<div id="dagevosHoe">
  ...
  <div class="container px-5 pt-mobile pb-mobile">
    ...
    <div class="row pb-mobile">
      <div class="col-sm-6">
        <div class="p-5" style="background-color: transparent; border-color: transparent;">
          <div class="">
            <h3 class="" v-html="hoeProp.hoe1.left.title"></h3>
          </div>
        </div>
    ...
    <div class="row ">
      ...
      <div class="col-sm-6 pt-mobile ">
        <div class="p-5" style="background-color: transparent; border-color: transparent;">
          <div v-html="hoeProp.hoe1.right.content">
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="container px-5 greyBackground  pt-mobile pb-mobile">
    <div class="row">
  ...
  <div class="container px-5  pt-mobile">
    <div class="row">
      ...
      <div class="col-sm-6  pb-mobile">
        <div class="p-5">
          <h4 class="mb-5" v-html="hoeProp.hoe4.left.title"></h4>
          </p>
          <div v-html="hoeProp.hoe4.left.content">
          </div>
        </div>
      </div>
      <div class="col-sm-6">

        <div class="float-left pullimage-right">
    ...
    <div class="row">
      ...
      <div class="col-sm-6">
        ...
        <div class="hidden-sm-up" style="margin-left:-15px;margin-right:-15px;">
          <div class="index-full-cover" :style="{'background-image':'url('+hoeProp.hoe2.right.imgpath+')'}" style="height:300px; width:100%;">
          </div>
        </div>
      </div>
