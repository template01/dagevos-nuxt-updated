<template>
  <div>
    <h4><nuxt-link class="ml-3 mr-3 mt-2 mb-2" to="/werkwijze">Wat en voor wie is het?</nuxt-link></h4>
    <h4><nuxt-link class="ml-3 mr-3 mt-2 mb-2" to="/aanbod">Hoe werkt het?</nuxt-link></h4>
